...
### FEATURE-4 — Різні кольори для публічної і особистої дошки
**Запит:** Публічний стіл і особистий простір мають виглядати різно щоб одразу було зрозуміло де ти знаходишся.
**Деталі:**
- Публічна дошка: поточний корковий колір (cork board — бежево-коричневий)
- Особиста дошка: інший фон — наприклад темно-зелений (як зелена скатертина) або синюватий
- Змінити тільки `background` канвасу в `EvidenceBoard.jsx` залежно від `tab`